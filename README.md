...
Setting up an environment, the command table and the repository layout live in
[DEVELOPERS.md](https://github.com/shutx-net/jumping-json-flush/blob/main/DEVELOPERS.md).
It is linked by URL rather than by path because release archives ship the READMEs
and not the contributor documentation.
